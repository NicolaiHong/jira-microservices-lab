...
- A record can carry a W3C `traceparent` header ([ADR 0006](../../docs/decisions/0006-distributed-tracing.md)). The header is transport metadata outside the envelope and the schema; a consumer may ignore it.
