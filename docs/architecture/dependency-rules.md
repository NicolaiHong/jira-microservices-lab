...
4. Use synchronous HTTP only where a current request, or an asynchronous projection immediately before a security-sensitive side effect, requires a current answer; use events for independent propagation.
